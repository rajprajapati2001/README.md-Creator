...
// @ts-ignore
import rootReadmeContent from "../../README.md?raw";

export const README_TEMPLATES: ReadmeTemplate[] = [
  {
    id: "main-template",
    name: "README Template",
    description: "Offical README.md template",
    category: "original",
    tags: ["Github", "Official", "README.md"],
...
export const TECH_ICONS: TechIcon[] = [
  ...
  { name: "GraphQL", slug: "graphql", color: "E10098", category: "database" },
  ...
  { name: "Heroku", slug: "heroku", color: "430098", category: "devops" },
  ...
  { name: "Less", slug: "less", color: "1D365D", category: "frontend" },
  { name: "WebAssembly", slug: "webassembly", color: "654FF0", category: "frontend" },
  ...
  { name: "Erlang", slug: "erlang", color: "A90533", category: "languages" },
  { name: "Cassandra", slug: "apachecassandra", color: "1287B1", category: "database" },
  { name: "MariaDB", slug: "mariadb", color: "003545", category: "database" },
  { name: "Neo4j", slug: "neo4j", color: "4581C3", category: "database" },
  { name: "CouchDB", slug: "apachecouchdb", color: "E42528", category: "database" },
  { name: "Ansible", slug: "ansible", color: "EE0000", category: "devops" },
  { name: "Terraform", slug: "terraform", color: "844FBA", category: "devops" },
  { name: "Jenkins", slug: "jenkins", color: "D24939", category: "devops" },
  { name: "CircleCI", slug: "circleci", color: "343434", category: "devops" },
  { name: "Datadog", slug: "datadog", color: "632CA6", category: "devops" },
  { name: "NGINX", slug: "nginx", color: "009639", category: "devops" },
  { name: "Apache", slug: "apache", color: "D22128", category: "devops" },
  { name: "Figma", slug: "figma", color: "F24E1E", category: "frontend" },
  { name: "Jest", slug: "jest", color: "C21325", category: "frontend" },
  { name: "Cypress", slug: "cypress", color: "17202C", category: "frontend" },
  { name: "Linux", slug: "linux", color: "FCC624", category: "devops" },
  { name: "Android", slug: "android", color: "3DDC84", category: "frontend" },
  { name: "iOS", slug: "ios", color: "000000", category: "frontend" }
];
